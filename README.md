...
- **`store`** - pass a corestore to be used for updates.
- **`swarm`** - pass a hyperswarm to be used for swarming updates. (need to handle store replecation manually if passed)
